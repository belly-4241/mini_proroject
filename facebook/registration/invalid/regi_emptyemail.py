...
def reg():
    ...
    time.sleep(1)
    driver.find_element(By.NAME, "reg_email__").send_keys("")
    time.sleep(1)
    driver.find_element(By.NAME, "reg_email_confirmation__").send_keys("belly4241@gmail.com")
    driver.find_element(By.ID, "password_step_input").send_keys("0503054241")
    time.sleep(1)
    ...
    time.sleep(3)
    fna = driver.find_element(By.XPATH,"//div[@id='js_27q']").text
    assert fna == 'js_27q'
